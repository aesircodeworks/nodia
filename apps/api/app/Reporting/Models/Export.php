 ...
 * generated file itself lands as a medialibrary attachment on this model
 * once BuildExport (task 15) exists; this task ships only the row and
 * its status-transition guards. The three transitions below are the
 ...
 * itself rather than a dedicated Action class because task 15's
 * BuildExport is the only caller and does not exist yet.
 *
 * @property string $id
