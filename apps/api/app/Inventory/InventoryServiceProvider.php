 ...
 * root). Stage-06 plan, task breakdown item 4: mounts the storefront hold
 * routes and registers HoldCreated (event-conventions, stage-04
 * precedent: a type is registered in the same task that ships its first
 * producer). Inventory ships no outbox consumers in this stage (stage-06
 * plan, Domain events: "Consumed: none"), so no SubscriberRegistry
 * wiring is needed here yet.
 */
