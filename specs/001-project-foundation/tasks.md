...
- [x] T034 [US2] Configure branch protection on `main` marking every workflow job required so a failing check blocks merge (via `gh api` or repository settings), and document the required-checks list in `README.md` (spec FR-008)
