...
_GATE: Must pass before Phase 0 research. Re-check after Phase 1 design. Gates derive from `.specify/memory/constitution.md`; cite the binding convention docs (api, data, event, ui) instead of restating their rules._
